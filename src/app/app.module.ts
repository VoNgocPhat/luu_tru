...
import { AttributeDiretiveModule } from './attribute-diretive/attribute-diretive.module';
...
@NgModule({
  ...
  imports: [
    BrowserModule,Baitap3Module,Baitap4Module,Baitap5Module,DataBindingModule,StructuralDirectiveModule,AttributeDiretiveModule
  ],
  providers: [],
